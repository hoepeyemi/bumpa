 ...
 * Use with ethers/viem + wallet. After deploying the Hardhat contract,
 * set VITE_SUBSCRIPTION_CONTRACT_ADDRESS and run: cd contracts && yarn compile && npx hardhat run scripts/export-abi.ts
 */
import { getContract } from "viem";
import { SUBSCRIPTION_CONTRACT_ADDRESS } from "./config";

// Minimal ABI for subscribe, pay, cancel and events (full ABI is in SubscriptionManager.json after export)

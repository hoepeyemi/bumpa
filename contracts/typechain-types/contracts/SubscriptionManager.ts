...
export interface SubscriptionManagerInterface extends Interface {
  ...
  decodeFunctionResult(functionFragment: "payFor", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "paymentToken",
    data: BytesLike
  ): Result;
...
export interface SubscriptionManager extends BaseContract {
  ...
  payFor: TypedContractMethod<
    [subscriptionId: BigNumberish, subscriber: AddressLike],
    [void],
    "nonpayable"
  >;
